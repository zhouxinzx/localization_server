...
void tdoaone(int Node_number, long double *measure_data, double *Microphone_Cita, double Microphone_Center_Location[Num_Node][2], double Microphone_Distance, double Room_Length, double Room_Width, int scale, double *result,int one)
{
	double Microphone_1_Location[Num_Node][2];
	double Microphone_2_Location[Num_Node][2];
	for (int i = 0; i<Node_number; i++)
...
void tdoatwo(int Node_number, long double *measure_data, double *Microphone_Cita, double Microphone_Center_Location[Num_Node][2], double Microphone_Distance, double Room_Length, double Room_Width, int scale, double *result,int two1,int two2)
{
	double Microphone_1_Location[Num_Node][2];
	double Microphone_2_Location[Num_Node][2];
	for (int i = 0; i<Node_number; i++)
